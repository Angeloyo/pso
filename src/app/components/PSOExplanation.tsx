...
export default function PSOExplanation() {
  return (
    <div className="max-w-3xl mx-auto mt-8 md:mt-12 ">
      <h3 className="text-lg md:text-xl font-semibold mb-4 md:mb-6" style={{ color: 'var(--foreground)' }}>Particle Swarm Optimization (PSO)</h3>
      
      <p className="text-sm md:text-base mb-6 md:mb-8" style={{ color: 'var(--foreground)', opacity: 0.8 }}>
      ...
      <div className="space-y-6 md:space-y-8">
        <div>
          <h4 className="text-base md:text-lg font-medium mb-3 md:mb-4" style={{ color: 'var(--foreground)' }}>Velocity Update:</h4>
        ...
        <div>
          <h4 className="text-base md:text-lg font-medium mb-3 md:mb-4" style={{ color: 'var(--foreground)' }}>Position Update:</h4>
          <div className="text-center mb-4 overflow-x-auto">
        ...
        <div>
          <h4 className="text-base md:text-lg font-medium mb-3 md:mb-4" style={{ color: 'var(--foreground)' }}>Parameters:</h4>
          <ul className="space-y-1 md:space-y-2 text-sm md:text-base" style={{ color: 'var(--foreground)', opacity: 0.8 }}>
